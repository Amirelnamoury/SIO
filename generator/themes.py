...
THEMES = {
    ...
    "electricien": {
        ...
        "tagline": "Électricien certifié, intervention rapide et aux normes",
        "services": [
    ...
    "macon": {
        ...
        "tagline": "Maçonnerie et gros œuvre : du solide, du durable",
        "services": [
    ...
    "peintre": {
        ...
        "tagline": "Peinture intérieure & extérieure, un rendu impeccable",
        "services": [
            "Peinture intérieure",
    ...
    "general": {
        ...
        "tagline": "Artisan du BTP : qualité, sérieux et devis gratuit",
        "services": [

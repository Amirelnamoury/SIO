...
const Api = {
  ...
  updateChantierDepense: (id, depenseId, payload) => apiFetch(`/chantiers/${id}/depenses/${depenseId}`, { method: "PATCH", body: payload }),
  addChantierHeures: (id, payload) => apiFetch(`/chantiers/${id}/heures`, { method: "POST", body: payload }),
  updateChantierHeures: (id, heureId, payload) => apiFetch(`/chantiers/${id}/heures/${heureId}`, { method: "PATCH", body: payload }),
  deleteChantierHeures: (id, heureId) => apiFetch(`/chantiers/${id}/heures/${heureId}`, { method: "DELETE" }),

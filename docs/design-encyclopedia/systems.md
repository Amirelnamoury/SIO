...
| ID | Columns | Max width | Gutter | Mobile transformation | Traits |
|---|---:|---:|---:|---|---|
| `classic_12` | 12 | 1280 | 24 | `stack_preserve_order` | balanced, modular |
| `editorial_8` | 8 | 1320 | 28 | `single_column_with_insets` | asymmetric, editorial |
| `asymmetric_5_7` | 12 | 1360 | 30 | `media_then_text` | asymmetric, split |
| `split_50_50` | 2 | 1440 | 0 | `stack_equal` | full_bleed, split |
| `split_40_60` | 10 | 1400 | 24 | `content_priority_stack` | offset, split |
| `split_35_65` | 20 | 1460 | 20 | `image_crop_then_stack` | cinematic, split |
| `architectural_3` | 3 | 1380 | 32 | `single_column_indexed` | architectural, strict |
| `portfolio_matrix` | 12 | 1520 | 18 | `two_then_one` | modular, portfolio |
| `modular_blocks` | 16 | 1440 | 16 | `ordered_blocks` | modular, stacked |
| `oversized_margin` | 10 | 1600 | 32 | `reduced_margin` | framed, quiet |
| `centered_narrow` | 6 | 880 | 22 | `full_width_readable` | centered, minimal |
| `wide_cinematic` | 16 | 1760 | 20 | `panorama_crop` | cinematic, full_bleed |
| `broken_editorial` | 14 | 1480 | 22 | `linearize_offsets` | broken_grid, editorial |
| `masonry_adaptive` | 12 | 1460 | 20 | `two_column_masonry` | masonry, visual_led |
| `rail_navigation` | 12 | 1500 | 24 | `rail_to_topbar` | architectural, rail |
| `edge_to_edge` | 12 | 1920 | 0 | `edge_crop` | bold, edge_to_edge |
| `framed_canvas` | 12 | 1500 | 28 | `remove_frame` | framed, luxurious |
| `layered_depth` | 12 | 1440 | 26 | `flatten_layers` | layered, spatial |
| `offset_sequence` | 10 | 1380 | 30 | `alternating_stack` | offset, story_led |
| `diagonal_rhythm` | 12 | 1520 | 24 | `remove_diagonal_overlap` | asymmetric, bold |

## Page silhouettes

| ID | Narrative | Minimum data | Images | Mobile transformation |
|---|---|---|---|---|
| `local_conversion` | header -> hero -> trust -> services -> area -> reviews -> faq -> contact -> footer | city, services | 0-4 | `cta_first_stack` |
| `premium_residential` | header -> hero -> manifesto -> services -> gallery -> about -> process -> contact -> footer | services | 3-10 | `editorial_sequence` |
| `project_ledger` | header -> hero -> featured_project -> project_grid -> services -> about -> reviews -> contact -> footer | project_media | 6-18 | `project_cards_to_rail` |
| `technical_capabilities` | utility_header -> hero -> capabilities -> process -> technical_details -> proof -> area -> contact -> footer | services | 1-6 | `technical_compact` |
| `craft_material_story` | header -> hero -> materials -> services -> process -> workshop -> gallery -> contact -> footer | services | 3-12 | `material_swipe` |
| `cinematic_residential` | overlay_header -> hero -> story -> projects -> before_after -> testimonial -> contact -> footer | services | 5-14 | `cinematic_to_chapters` |
| `urgent_local` | phone_header -> problem_hero -> urgent_actions -> services -> area -> trust -> faq -> contact -> footer | emergency_service, phone, services | 0-3 | `sticky_call` |
| `minimal_statement` | quiet_header -> statement_hero -> projects -> services -> about -> contact -> footer | services | 0-8 | `quiet_stack` |
| `quote_first_service` | header -> quote_hero -> service_index -> process -> proof -> form -> footer | services | 0-4 | `form_first` |
| `phone_first_service` | phone_header -> compact_hero -> issue_index -> services -> area -> contact -> footer | phone, services | 0-2 | `bottom_call_dock` |
| `editorial_residential` | index_header -> editorial_hero -> essay -> gallery -> selected_services -> about -> contact -> footer | services | 4-12 | `magazine_stack` |
| `architectural_contracting` | rail_header -> hero -> project_intro -> capabilities -> project_grid -> process -> contact -> footer | services | 4-12 | `rail_to_index` |
| `specification_first` | utility_header -> technical_hero -> specification -> services -> process -> proof -> contact -> footer | services | 0-5 | `accordion_spec` |
| `family_trust` | local_header -> hero -> family_story -> services -> proof -> reviews -> area -> contact -> footer | services | 1-6 | `trust_before_story` |
| `local_service_story` | header -> hero -> story -> services -> process -> area -> contact -> footer | services | 1-6 | `linear_story` |
| `transformation_story` | overlay_header -> hero -> before_after -> narrative -> services -> process -> projects -> contact -> footer | services | 4-14 | `paired_transformations` |
| `industrial_capabilities` | utility_header -> hero -> sectors -> capabilities -> process -> certifications -> contact -> footer | services | 1-7 | `capability_accordion` |
| `magazine_service` | editorial_header -> cover_hero -> contents -> services -> essays -> gallery -> contact -> footer | services | 2-10 | `contents_to_tabs` |
| `warm_artisan` | atelier_header -> hero -> introduction -> services -> process -> workshop -> contact -> footer | services | 1-8 | `warm_compact` |
| `bold_local` | bold_header -> oversized_hero -> services -> proof -> area -> reviews -> contact -> footer | services | 0-5 | `bold_action_stack` |
| `documentary_process` | quiet_header -> documentary_hero -> process_chapters -> services -> people -> gallery -> contact -> footer | services | 5-16 | `chapter_scroll` |
| `design_build_journey` | header -> hero -> brief -> design -> build -> reveal -> services -> contact -> footer | services | 4-14 | `phase_accordion` |
| `heritage_story` | classic_header -> hero -> heritage -> materials -> process -> projects -> contact -> footer | services | 3-12 | `heritage_chapters` |
| `spatial_explainer` | minimal_header -> spatial_hero -> system_map -> capabilities -> process -> contact -> footer | services | 0-5 | `static_diagram` |
| `material_library` | index_header -> macro_hero -> material_index -> services -> applications -> gallery -> contact -> footer | services | 6-18 | `material_carousel` |
| `quiet_luxury` | minimal_header -> statement_hero -> selected_services -> image_sequence -> about -> contact -> footer | services | 2-8 | `quiet_sequence` |
| `gallery_sequence` | overlay_header -> visual_hero -> gallery_sequence -> service_links -> about -> contact -> footer | project_media, services | 8-20 | `horizontal_to_vertical` |
| `editorial_manifesto` | index_header -> type_hero -> manifesto -> services -> visual_break -> about -> contact -> footer | services | 0-6 | `type_scale_reduction` |
...
|---|---:|---:|---|---|
| `none` | 0 | 0 | - | `none` |
| `micro_feedback` | 1 | 1 | hover, focus, button_state | `instant_state` |
| `soft_fade` | 1 | 1 | opacity_reveal | `visible` |
| `directional_slide` | 2 | 1 | short_translate | `visible` |
| `editorial_reveal` | 2 | 2 | line_mask, image_reveal | `visible` |
| `measured_stagger` | 2 | 2 | small_stagger | `visible` |
| `image_crop_reveal` | 3 | 2 | clip_path_reveal | `uncropped_image` |
| `subtle_parallax` | 3 | 3 | limited_parallax | `static_position` |
| `sticky_storytelling` | 4 | 3 | sticky_chapter | `linear_chapters` |
| `horizontal_rail` | 3 | 2 | horizontal_scroll, snap | `vertical_list` |
| `cinematic_sequence` | 4 | 4 | chapter_crossfade, slow_scale | `linear_sequence` |
| `spatial_explainer` | 4 | 4 | diagram_progress, depth_layers | `static_diagram` |

## Spatial systems

| ID | Level | Cost | Techniques | Mobile fallback |
|---|---:|---:|---|---|
| `none` | 0 | 0 | - | `none` |
| `diagrammatic` | 1 | 1 | svg_diagram | `static_svg` |
| `isometric` | 2 | 2 | isometric_svg | `flat_diagram` |
| `layered_2_5d` | 2 | 2 | layered_css | `flat_layers` |
| `parallax_depth` | 3 | 3 | limited_parallax | `stacked_media` |
| `css_perspective` | 3 | 2 | css_perspective | `flat_cards` |
| `svg_spatial` | 3 | 2 | animated_svg | `static_svg` |
| `lightweight_canvas` | 4 | 4 | canvas_diagram | `static_image` |
| `webgl_optional` | 5 | 5 | progressive_webgl | `poster_image` |
...
| `phone_action_dock` | compact_top_bar | problem_then_phone | service_list | bottom_actions | micro_only |
| `project_casebook` | project_index | project_cover | snap_casebook | project_enquiry | reduced |
| `documentary_chapters` | drawer | captioned_image | chapter_stack | inline | soft |
| `local_information` | action_dock | compact_conversion | service_accordion | sticky_quote | micro_only |
| `spatial_fallback` | compact_drawer | static_diagram | linear_explainer | inline | static |
